...
**Using `Galaxy`, generating this data would take too long for this workshop.**
...
::: { .callout-caution }
You may need to right click on the link and choose `Save Link As...` to download this data.
:::
...
2. Your isolate `ERR531380` was sampled from bed 11. Using @tbl-isolates1 to identify the other bed 11 isolates, find where they are in the tree. What do you notice?
