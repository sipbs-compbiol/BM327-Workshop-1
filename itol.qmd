...
As a reminder, and to help with tree annotation, the interactive table of isolate metadata is shown below in @tbl-isolates2.
...
1. Using @tbl-isolates2, what feature of the data appears to be common between the sequences in the clade of seven sequences including `ERR43133` and `ERR531418`?
...
1. Sort @tbl-isolates2 by bed number by clicking on one of the triangles next to the `Bed` header
