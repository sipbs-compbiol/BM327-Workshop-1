...
![Per base quality score plot from `Falco` indicating improvement in read quality, post-`trimmomatic`.](assets/images/falco_perbase_clean.png){#fig-fastqc-perbase width=80%}

## Next steps

Now that we have clean, high-quality sequencing reads, we can move on to mapping the reads to a reference genome, in @sec-map-reference.
