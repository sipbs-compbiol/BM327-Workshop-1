...
![Per base quality score plot from `Falco` indicating an improvement in read quality, post-`trimmomatic`.](assets/images/falco_perbase_clean.png){#fig-fastqc-perbase width=80%}
