...
4. Choose the `ERR531413_asm.fasta.gz` file in `Use the following dataset as the reference sequence`
...
::: { .callout-todo }
**GENERATE VIDEO OF USING SNIPPY IN GALAXY**
:::
...
::: { .callout-todo }
**GENERATE IMAGE OF SNIPPY TABLE OUTPUT**
:::
