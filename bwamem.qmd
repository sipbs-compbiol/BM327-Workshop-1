...
4. Choose the `GCF_000006765.1_ASM676v1_genomic.fna.gz` sequence under `Use the following dataset as the reference sequence`
...
::: { .callout-todo }
**GENERATE THE VIDEO OF INSPECTING THE MAPPING FILE**
:::
