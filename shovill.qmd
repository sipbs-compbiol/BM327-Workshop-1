...
::: { .callout-caution }
You may need to right-click the links and select `Save Link As...` to download the data.
:::
...
::: { .callout-important }
`CheckM` may take a few minutes to complete.
:::
...
::: { .callout-question }
What does `CheckM` tell you about the quality of this assembly?
:::
